...
Ejemplo modelo: [https://carherco.es/curso-angular-ejercicio-final](https://carherco.es/curso-angular-ejercicio-final)
...
2. Añade Angular Material: [https://material.angular.io/guide/getting-started](https://material.angular.io/guide/getting-started). (Este punto es mejor hacerlo nada más empezar que una vez terminada la mini-aplicación).
...
Ejemplo modelo: [https://carherco.es/curso-angular/#/galeria](https://carherco.es/curso-angular/#/galeria)
...
Ejemplo modelo: [https://carherco.es/curso-angular/#/rotate](https://carherco.es/curso-angular/#/rotate)
